...
(function (root, factory) {
    ...
    var Imgur = function (options) {
        ...
        this.info = document.querySelectorAll('.input-group-append');
    ...
    Imgur.prototype = {
        ...
        createDragZone: function () {
            ...
            //<a class="btn btn-outline-secondary" id="image_uploader_zone" role="button">Upload<input class="input" accept="image/*" type="file"></a>
            Array.prototype.forEach.call(this.info, function (zone) {
                zone.appendChild(input0);
                this.status(zone);
                this.upload(zone);
            }.bind(this));
        },
        loading: function () {
            ...
            //document.getElementById("input-group-append").appendChild(div);
        },
        status: function (el) {
        ...
        matchFiles: function (file, zone) {
            var status = zone.previousSibling;
